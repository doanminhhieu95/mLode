    ...
    <div class="page-lode">
        <div class="block">
            <div style="background: #f6f6f6;" class="bhead">
                <div id="BDHeader" class="fl">Biên đề - Miền Nam</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('miennam')}}" method="post">
...
<script>
    $(document).ready(function () {
        ...
        $.get("lo-de-mien-nam/ajax/kieuchoi/" + idloaide, function (data) {
            $("#kieuchoi").html(data);
            var idkieuchoi = $('#kieuchoi').val();
            $.get("lo-de-mien-nam/ajax/luatchoi/" + idkieuchoi, function (data) {
                $("#luatchoi").html(data);
            });
            $.get("lo-de-mien-nam/ajax/chonso/" + idkieuchoi, function (data) {
                $("#bet_type_content").html(data);
            });
            $.get("lo-de-mien-nam/ajax/max/" + idkieuchoi, function (data) {
                $("#max").val(data);
            });
            $.get("lo-de-mien-nam/ajax/money/" + idkieuchoi, function (data) {
                $("#dat").html(data);
        ...
        $.get("lo-de-mien-nam/ajax/city/" + thu, function (data) {
            $("#city").html(data);
        });
